/* eslint-disable eqeqeq, no-undefined, no-undef, radix, @stylistic/max-len, @stylistic/no-mixed-operators, no-console, func-style, jsdoc/no-undefined-types, block-scoped-var, require-await, no-var, no-redeclare, no-return-assign, prefer-promise-reject-errors, no-unused-vars, no-eq-null, prefer-const, no-throw-literal */
require('core-js');
...
class HttpDevice{
    ...
    async connect (){
        ...
        return connect = new Promise((resolve, reject) => {
            ...
            swal(translate._getText('connectwlan', this.locale), { // lets the user choose between wlan and usb
                ...
                .then(x => fetch(`${url}/api/v1/workspaces/scratchserver`,
                    {
                        method: 'GET',
                        headers: {
                            'X-API-KEY': apikey
                ...
                .then(x => fetch(`${url}/api/v1/workspaces?workspace_name=scratchserver`,
                    {
                        method: 'POST',
                        headers: {
                            'X-API-KEY': apikey
                ...
                .then(x => fetch(`${url}/api/v1/workspaces/scratchserver/files`,
                    {
                        method: 'POST',
                        headers: {
                            'X-API-KEY': apikey
                ...
                .then(x => fetch(`${url}/api/v1/application/scratchserver/start`,
                    {
                        method: 'POST',
                        headers: {
                            'X-API-KEY': apikey
    ...
    connecthand (){
        const img = document.getElementById('ft_connect_button');
        try {
