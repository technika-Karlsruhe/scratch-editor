/*
  scratch3_tx/index.js
    ...
    extension called TX is opened a connection can be established to a fischertechnik
    TX controller by clicking the orange connect button. Then, holt the red
    "Select"-button on the TX until the blinking blue LED blinks with a much higher
    ...
    TX turns orange. Depending on whether you allowed notifications, you will either
...
class Scratch3TXBlocks {
    constructor (runtime) {
        ...
        globalThis.openedextensions.push('TX');
